...
class GetCatsFamilyFriendlyUsecase implements UseCase<DataState<List<CatEntity>>, int> {
  final CatRepository _catRepository;

  GetCatsFamilyFriendlyUsecase(this._catRepository);

  @override
  Future<DataState<List<CatEntity>>> call({int? params}) async {
    return await _catRepository.getCatsFamilyFriendly(familyFriendly: params!);
  }
